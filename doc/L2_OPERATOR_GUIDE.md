...
- **Security**: Optimistic rollup with fraud proofs anchored to L1
- **Reputation integration**: HAT v2 trust scores for sequencer eligibility and fast withdrawals
...
| Sequencer count | 5+ | <3 |
| Leader uptime | 99%+ | <95% |
| Pending withdrawals | <1000 | >5000 |
| TVL change | <5%/day | >10%/day |
...
**Symptom**: Deposits or withdrawals not processing

**Diagnosis**:
```bash
# Check withdrawal status
cascoin-cli l2_getwithdrawalstatus <withdrawal-id>
...
- Check for fraud proof challenges
