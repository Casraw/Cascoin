...
enum DeploymentPos
{
    ...
    DEPLOYMENT_MINOTAURX,   // Cascoin: MinotaurX+Labyrinth1.2: Deployment
...
struct Params {
    ...
    uint256 powLimitLabyrinth;               // Highest (easiest) mouse hash target
    uint32_t labyrinthNonceMarker;           // Nonce marker for labyrinthmined blocks
    ...
    int labyrinthTargetAdjustAggression;     // Snap speed for mouse hash target adjustment EMA
