...
static const int DEFAULT_LABYRINTH_CHECK_DELAY = 1;
static const int DEFAULT_LABYRINTH_THREADS = -2;
static const bool DEFAULT_LABYRINTH_EARLY_OUT = true;

// Cascoin: MinotaurX+Labyrinth1.2
static const bool DEFAULT_LABYRINTH_CONTRIB_CF = true;
...
public:
    ...
    std::unique_ptr<CBlockTemplate> CreateNewBlock(const CScript& scriptPubKeyIn, bool fMineWitnessTx=true, const CScript* labyrinthProofScript=nullptr, const POW_TYPE powType=POW_TYPE_SHA256);
...
void CheckBinMinotaurX(int threadID, std::vector<CMouseRange> bin, std::string deterministicRandString, arith_uint256 mouseHashTarget); // Cascoin: MinotaurX+Labyrinth1.2: Use minotaur inner hash for labyrinth
