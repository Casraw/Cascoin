    ...
    transactionView(0), abandonAction(0), bumpFeeAction(0), columnResizingFixer(0)
{
    ...
    typeWidget->addItem(tr("Labyrinth mouse creation"), TransactionFilterProxy::TYPE(TransactionRecord::LabyrinthMouseCreation));         // Cascoin: Labyrinth
    typeWidget->addItem(tr("Labyrinth community fund"), TransactionFilterProxy::TYPE(TransactionRecord::LabyrinthCommunityFund));     // Cascoin: Labyrinth
    typeWidget->addItem(tr("Labyrinth-mined cheese"), TransactionFilterProxy::TYPE(TransactionRecord::LabyrinthCheese));                 // Cascoin: Labyrinth
