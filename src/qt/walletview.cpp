...
#include <qt/labyrinthdialog.h>      // Cascoin: Labyrinth page
#include <qt/mousenftpage.h>      // Cascoin: Mouse NFT page
    ...
    platformStyle(_platformStyle)
{
    ...
    labyrinthPage = new LabyrinthDialog(platformStyle); // Cascoin: Labyrinth page
...
void WalletView::setBitcoinGUI(BitcoinGUI *gui)
{
    if (gui)
    {
        ...
        connect(overviewPage, SIGNAL(mouseButtonClicked()), gui, SLOT(gotoLabyrinthPage()));
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    if (_walletModel)
    {
        ...
        connect(_walletModel, SIGNAL(requireUnlockLabyrinth()), this, SLOT(unlockWalletLabyrinth()));
...
void WalletView::gotoLabyrinthPage()
{
...
void WalletView::unlockWalletLabyrinth()
{
    if(!walletModel)
        return;
    // Unlock wallet when requested by wallet model
    if (walletModel->getEncryptionStatus() == WalletModel::Locked)
    {
        AskPassphraseDialog dlg(AskPassphraseDialog::UnlockLabyrinthMining, this);
        dlg.setModel(walletModel);
        dlg.exec();
    }
}
