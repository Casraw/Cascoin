    ...
    platformStyle(_platformStyle)
{
    ...
    connect(labyrinthStatusIcon, SIGNAL(clicked(QPoint)), this, SLOT(gotoLabyrinthPage()));
...
void BitcoinGUI::createActions()
{
    ...
    connect(labyrinthAction, SIGNAL(triggered()), this, SLOT(gotoLabyrinthPage()));           // Cascoin: Labyrinth page
...
void BitcoinGUI::gotoLabyrinthPage()
{
    labyrinthAction->setChecked(true);
    if (walletFrame) walletFrame->gotoLabyrinthPage();
}
