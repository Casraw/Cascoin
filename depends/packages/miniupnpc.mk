...
$(package)_build_opts_mingw32=-f Makefile.mingw libminiupnpc.a
...
define $(package)_build_cmds
	$(MAKE) -j$(JOBS) $($(package)_build_opts)
endef

define $(package)_stage_cmds
	mkdir -p $($(package)_staging_prefix_dir)/include/miniupnpc $($(package)_staging_prefix_dir)/lib &&\
	install include/*.h $($(package)_staging_prefix_dir)/include/miniupnpc &&\
	install miniupnpcstrings.h $($(package)_staging_prefix_dir)/include/miniupnpc &&\
